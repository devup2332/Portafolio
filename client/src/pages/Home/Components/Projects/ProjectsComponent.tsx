            ...
            <div className="projects-subcontainer">
                ...
                <div className="projects">
                        ...
                        <div className="item-second-descr">
                            ...
                            <div className="btns-item">
                                ...
                                <button className="btn-code-item">
                                    <a
                                        href="https://github.com/devup2332/ChatApp"
                                        target="_blank"
                                    >
                                        Code
                                    </a>
                    ...
                    <div className="item">
                        ...
                        <div className="item-primary-descr">
                            <p className="item-descr">
                                On the other hand, we denounce with righteous On
                                the other hand, we denounce with righteous On
                        ...
                        <div className="item-second-descr">
                            ...
                            <div className="btns-item">
                                ...
                                <button className="btn-code-item">
                                    <a
                                        href="https://github.com/devup2332/GalleryApp"
                                        target="_blank"
                                    >
                                        Code
                                    </a>
